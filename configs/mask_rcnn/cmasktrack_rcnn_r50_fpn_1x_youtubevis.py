...
log_level = 'INFO'
work_dir = '/media/data/coky/OVIS/cmasktrack_rcnn_r50_fpn_1x_yvis'
load_from = 'https://open-mmlab.oss-cn-beijing.aliyuncs.com/mmdetection/models/mask_rcnn_r50_fpn_1x_20181010-069fa190.pth'
resume_from = None
workflow = [('train', 1)]
